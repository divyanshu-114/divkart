...
export const generateEmailTemplate = (resetPasswordUrl) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000; color: #fff;">
      <h2 style="color: #fff; text-align: center;">Oops... Someone Forgot Their Password 😏</h2>
      
      <p style="font-size: 16px; color: #ccc;">Hey Forgetful,</p>
      
      <p style="font-size: 16px; color: #ccc;">Looks like *someone* clicked "Forgot Password" again.  
      Don't worry, we won’t judge… much. 😌</p>

      <p style="font-size: 16px; color: #ccc;">Click the magical button below to reset your password before you forget this email too:</p>
      ...
      <p style="font-size: 16px; color: #ccc;">If you didn't request this… then who used your brain today? 👀</p>

      <p style="font-size: 16px; color: #ccc;">Anyway, if the button refuses to cooperate (like your brain on Mondays), just copy and paste this link:</p>

      <p style="font-size: 16px; color: #fff; word-wrap: break-word;">${resetPasswordUrl}</p>

      <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
        <p>Yours truly,<br>The Password Rescue Squad 🚀</p>
        <p style="font-size: 12px; color: #444;">P.S. This is an automated message.  
        Even the computer knows you forget things.</p>
      </footer>
    </div>
  `;
};
